...
// Website: https://xchain.cx
// Telegram: https://t.me/x_chain_official
// Twitter: https://twitter.com/xchain_official


// 𝕏-Chain is a Layer-1 PoA blockchain with 100k TPS (Fastest & Cheapest) where you can build scalable decentralized applications.
...
contract xchain is ERC20, Ownable{
    ...
    uint256 public maxTxAmount = 1_500_000_000 * 10**18;
    uint256 public maxWalletAmount = 2_000_000_000 * 10**18;
    
    address public marketingWallet = 0x08590d690c62c8a4FEcd9d9F755f93c86B071800;
    address public devWallet = 0x4B11819DF4D9c6aF80B156C3CA3d63f5AEec4E2c;
    ...
    Taxes public taxes = Taxes(24,0,6);
    ...
    modifier inSwap() {
     ...
     constructor() ERC20("X-Chain", "XCHAIN") {
